...
**Example 1**
* The following command searches for and returns all directories in `written_2/non-fiction/OUP`. This is useful when searching for a given path's directories and not the files inside them.
```
...
**Example 2**
* The following command searches for and returns all files in `written_2/non-fiction/OUP`. This is useful when searching for a given path's files and not its directories.
```
