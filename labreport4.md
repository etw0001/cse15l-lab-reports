...
`git add L <tab> .j <tab>`
* I accessed the command `git add ListExamples.java` quicker by using `<tab>` to autofill the `ListExamples.java` part of my command. This staged the changes for the next commit.
